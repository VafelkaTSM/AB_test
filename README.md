...
- Проверка SRM: пройдена (p=0.9081) (хотя реальные данные, использованные для теста метрик, были меньше, так как брались количеством в соотвествии с MDE для чистоты экмперимента, а размер групп в сгенерированной выборке больше)
